/*****************************************************************************
* File Name: TCP No Blocking Server - ADT
...
#ifndef __TCP_NO_BLOCKING_SERVER_H__
#define __TCP_NO_BLOCKING_SERVER_H__
...
typedef enum TCPServerError
{
    ...
    TCP_SERVER_RECV_NO_MESSAGE_AVAILABLE,
...
/* Description:
 * A function that creating a new available tcp no blocking server. Memory will be specially 
 * allocated.
 *
 * Time Complexity: O(1).
 *
 ...
 * NULL - create socket/setsockpot/bind/listen/change server to no blocking mode failed.
 ...
 * client is not possible.
 */
TCPServerError_t CheckCurrClients(TCPServer_t *tcpServer);
...
#endif /* __TCP_NO_BLOCKING_SERVER_H__ */
