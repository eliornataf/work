 ...
 * None.
 */
typedef void (*NewClientFunc_t)(TCPServer_t *tcpServer, TCPClient_t *tcpClient);
 ...
 * None.
 */
typedef void (*CloseClientFunc_t)(TCPServer_t *tcpServer, int clientID);
 ...
 * messageSize - the size of the received message.
 *
 * Output:
 * None.
 *
 ...
 * None.
 */
typedef void (*ClientMessageFunc_t)(TCPServer_t *tcpServer, int clientID, void *message, size_t messageSize);
 ...
 * None.
 */
typedef int (*ErrorFunc_t)(TCPServer_t *tcpServer, TCPServerError_t errorCode);
 ...
 * when an error has occurred in the server. pointer cannot be NULL. 
 *
 * Output:
 ...
 * NULL - errorFunc pointer is NULL, create is not possible.
 ...
 * NULL - create internal functions error.
 */
TCPServer_t *CreateServer(char *serverIPAddress, size_t serverPort, size_t queueLength, size_t maxConnectClients, NewClientFunc_t newClientFunc, CloseClientFunc_t closeClientFunc, ClientMessageFunc_t clientMessageFunc, ErrorFunc_t errorFunc);
