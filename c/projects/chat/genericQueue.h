...
#define IS_EMPTY (1)
#define POINTER_NOT_INITIALIZE_QUEUE_IS_EMPTY (2)

#define POINTER_NOT_INITIALIZE_QUEUE_FOR_EACH (999)
#define UNDERFLOW_QUEUE_FOR_EACH (999)
 ...
 * return 2, is empty check is not possible. 
 ...
 * UNDERFLOW_QUEUE_FOR_EACH - the queue is empty, return 999 items,
