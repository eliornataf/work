...
const char *BookInfo::GetName() const {
    return this->m_name;
}

const char *BookInfo::GetAutourName() const {
    return this->m_authorName;
}

const size_t BookInfo::GetReleaseYear() const {
    return this->m_releaseYear;
}

const char *BookInfo::GetPurchasedDate() const {
